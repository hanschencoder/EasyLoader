...
public class ContactsPhotoRequestHandler extends RequestHandler {
    ...
    public boolean canHandleRequest(Request request) {
        ...
        return (SCHEME_CONTENT.equals(uri.getScheme()) && ContactsContract.Contacts.CONTENT_URI.getHost()
                                                                                               .equals(uri.getHost()) && matcher.match(
                request.uri) != UriMatcher.NO_MATCH);
    }
