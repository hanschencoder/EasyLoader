...
class Stats {
    ...
    Stats(LruMemoryCache<String, Bitmap> cache) {
        this.cache = cache;
    ...
    StatsSnapshot createSnapshot() {
        return new StatsSnapshot(cache.maxSize(), cache.size(), cacheHits, cacheMisses, totalDownloadSize, totalOriginalBitmapSize, totalTransformedBitmapSize, averageDownloadSize, averageOriginalBitmapSize, averageTransformedBitmapSize, downloadCount, originalBitmapCount, transformedBitmapCount, System
                .currentTimeMillis());
    }
    ...
    private void processBitmap(Bitmap bitmap, int what) {
        ...
        int bitmapSize = BitmapUtils.getBitmapBytes(bitmap);
