...
/**
 * Represents all stats for a {@link EasyLoader} instance at a single point in time.
 */
public class StatsSnapshot {
    ...
    public StatsSnapshot(long maxSize,
                         long size,
                         long cacheHits,
                         long cacheMisses,
    ...
    public void dump() {
        ...
        EasyLoaderLog.d("Picasso", logWriter.toString());
    }
